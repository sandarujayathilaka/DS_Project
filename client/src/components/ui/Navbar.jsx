    ...
    return (
        <header className="header sticky top-0 bg-orange-100 shadow-md flex items-center justify-between px-8 py-2">
            ...
            <div className="w-3/12 flex justify-end">
                <a href="/">
                    <img src={SearchIcon} alt="Search" className="h-8 p-1 hover:text-cyan-500 duration-200" />
                </a>
                <a href="/">
                    <img src={ShoppingCartIcon} alt="Shopping Cart" className="h-8 p-1 hover:text-cyan-500 duration-200" />
                </a>
                <button className="bg-teal-500 text-white font-semibold px-4 py-2 rounded-md ml-4 hover:bg-cyan-600 duration-200"> Log out </button>
            </div>
        </header>
    );
}
