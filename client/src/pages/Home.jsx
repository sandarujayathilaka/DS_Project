      ...
      <section className="bg-yellow-50 text-gray-800">
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between lg:p-12 xl:p-16">
          <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 className="text-5xl font-bold leading-none sm:text-6xl">Getting Quality<br></br>
              <span className="text-cyan-500">Education is Now<br></br></span>More Easy
            </h1>
            <p className="mt-6 mb-8 text-lg sm:mb-12">Explore a world of knowledge with us.<br/>
              <br className="hidden md:inline lg:hidden" />From flexible courses to expert instructors, embark on your learning journey and unlock your full potential.
            </p>
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
              <a rel="noopener noreferrer" href="#" className="px-8 py-3 text-lg font-semibold rounded bg-teal-500 text-gray-50">Courses</a>
              <a rel="noopener noreferrer" href="#" className="px-8 py-3 text-lg font-semibold border rounded border-gray-800">Join with Us</a>
            </div>
          </div>
          <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-96 sm:h-96 lg:h-96 xl:h-112 2xl:h-128">
            <img src={images[currentImageIndex]} alt="" className="object-contain h-96 w-auto xl:h-112 2xl:h-128" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-yellow-50 text-gray-800">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="relative mb-12 px-3 lg:mb-0 text-center">
            <div className="mb-8 flex justify-center mt-8">
              <span className="text-primary">
                <img src={packageIcon} alt="Package Icon" className="h-14 w-14" />
              </span>
            </div>
      ...
      <section className="py-6 sm:py-12 bg-yellow-50 text-gray-800">
        <div className="container p-6 mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
                <article className="flex flex-col bg-red-50">
                    <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum">
                        <img alt="" className="object-cover w-full h-52 bg-gray-500" src={it} />
                    </a>
                    <div className="flex flex-col flex-1 p-6">
                        <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum"></a>
                        <a rel="noopener noreferrer" href="#" className="text-xs tracking-wider uppercase hover:underline text-cyan-600">Information Technology</a>
                        <h3 className="flex-1 py-2 text-lg font-semibold leading-snug">Te nulla oportere reprimique his dolorum</h3>
                        <div className="flex flex-wrap justify-between pt-3 space-x-2 text-xstext-gray-600">
                ...
                <article className="flex flex-col bg-red-50">
                    <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum">
                        <img alt="" className="object-cover w-full h-52 bg-gray-500" src={ds} />
                    </a>
                    <div className="flex flex-col flex-1 p-6">
                        <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum"></a>
                        <a rel="noopener noreferrer" href="#" className="text-xs tracking-wider uppercase hover:underline text-cyan-600">Data Science</a>
                        <h3 className="flex-1 py-2 text-lg font-semibold leading-snug">Te nulla oportere reprimique his dolorum</h3>
                ...
                <article className="flex flex-col bg-red-50">
                    <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum">
                        <img alt="" className="object-cover w-full h-52 :bg-gray-500" src={se} />
                    </a>
                    <div className="flex flex-col flex-1 p-6">
                        <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum"></a>
                        <a rel="noopener noreferrer" href="#" className="text-xs tracking-wider uppercase hover:underline text-cyan-600">Software Engineering</a>
                        <h3 className="flex-1 py-2 text-lg font-semibold leading-snug">Te nulla oportere reprimique his dolorum</h3>
                        <div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs text-gray-600">
                ...
                <article className="flex flex-col bg-red-50">
                    <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum">
                        <img alt="" className="object-cover w-full h-52 bg-gray-500" src={cs} />
                    </a>
                    <div className="flex flex-col flex-1 p-6">
                        <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum"></a>
                        <a rel="noopener noreferrer" href="#" className="text-xs tracking-wider uppercase hover:underline text-cyan-600">Cyber Security</a>
                        <h3 className="flex-1 py-2 text-lg  font-semibold leading-snug">Te nulla oportere reprimique his dolorum</h3>
                        <div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs text-gray-600">
